...
function getRecipeByDescription(desc) {
    ...
    const recipes = {
        ...
        'галета': { name: 'Сирна галета зі сливами', category: 'Сніданок', time: 40, ingredients: ['250 г борошна', '125 г масла', '1 яйце', '300 г сиру', '80 г цукру', '6-8 слив', '1 ст.л. крохмалю', 'Цукрова пудра'], steps: ['Замісити тісто з борошна, масла та яйця.', 'Охолодити тісто 30 хвилин.', 'Розкачати та викласти у форму.', 'Змішати сир з цукром та крохмалем.', 'Викласти сирну начинку.', 'Сливи розрізати навпіл, викласти зверху.', 'Запікати при 180°C 30-35 хвилин.', 'Посипати цукровою пудрою.'] },
        'слива': { name: 'Галета зі сливами', category: 'Десерт', time: 45, ingredients: ['200 г борошна', '100 г масла', '50 г цукру', '1 яйце', '400 г слив', '2 ст.л. манки', 'Кориця'], steps: ['Замісити тісто.', 'Розкачати у круг.', 'Посипати манкою.', 'Викласти сливи.', 'Підняти краї тіста.', 'Випікати при 190°C 30-35 хвилин.'] },
        ...
        'торт': { name: 'Шоколадний торт', category: 'Святкова страва', time: 60, ingredients: ['200 г борошна', '200 г цукру', '100 г какао', '3 яйця', '200 мл молока', 'Масло'], steps: ['Змішати сухі інгредієнти.', 'Додати яйця та молоко.', 'Випекти 2 коржі.', 'Промазати кремом.'] },
        'піца': { name: 'Піца Маргарита', category: 'Вечеря', time: 40, ingredients: ['300 г борошна', '200 г моцарели', '3 помідори', 'Базилік', 'Оливкова олія'], steps: ['Замісити тісто.', 'Розкачати корж.', 'Викласти начинку.', 'Випікати при 200°C 15-20 хвилин.'] },
        'салат': { name: 'Святковий салат', category: 'Святкова страва', time: 30, ingredients: ['300 г курки', '100 г тертого сиру', '3 яйця', '100 г горіхів', 'Майонез'], steps: ['Зварити курку та яйця.', 'Нарізати кубиками.', 'Додати горіхи та сир.', 'Заправити майонезом.'] },
        ' Ủchunu': { name: 'Сирна галета', category: 'Сніданок', time: 35, ingredients: ['300 г борошна', '150 г масла', '1 яйце', '400 г сиру', '100 г цукру', 'Ванілін'], steps: ['Замісити тісто.', 'Розкачати у круг.', 'Змішати сир з цукром.', 'Викласти начинку.', 'Запікати при 180°C 25 хвилин.'] }
    };
